const data: Record<TProductId, TProduct> = {
  '2zd33b8c': {
    name: 'El Nacimiento de Venus, Sandro Botticelli',
    id: '2zd33b8c',
    sku: 'NUR72KCM',
    price: 1484,
    image: '/images/nacimientodevenus.jpg',
    attributes: {
      description:
      ...
      shape: 'Temple (278,5 x 172,5 cm)',
      hardiness: 'Galeria Uffizi, Florencia (Italia)',
      taste: 'Cuenta el mito que Saturno (Cronos), dios del tiempo, desgarra y lanza los genitales de su padre Caelos (Urano), lo que fertiliza el mar. El roce de la espuma engendra a Venus que, con la ayuda del viento, es transportada hasta las orillas de la isla de Chipre en una concha marina. Allí, es llevada por ‘las Horas’ al lugar de los ‘Inmortales’.',
    },
  },
  '6trfgkkj': {
    name: 'La Creacion de Adan, Michelangelo Buonarrotti',
    id: '6trfgkkj',
    sku: 'AX4M8SJV',
    price: 1511,
    image: '/images/creaciondeadan.jpg',
    attributes: {
      description:
      ...
      shape: 'Fresco (280 x 570 cm)',
      hardiness: 'Capilla Sixtina, Roma (Italia)',
      taste: 'En la obra, detras de la imagen de Dios muchos ven la composicion de perfecto cerebro humano, otros sin embargo notan un utero, con el cordon recien cortado y si miramos atentamente Adan fue pintado con ombligo... ',
    },
  },
  '7bcr49em': {
    name: 'La Gioconda, Leonardo Da Vinci',
    id: '7bcr49em',
    sku: 'HYA78F6J',
    price: 1503,
    ...
    attributes: {
      ...
      shape: 'Óleo (77 x 53 cm)',
      hardiness: 'Louvre, París (Francia)',
      taste: 'A comienzos del siglo pasado esta obra fue robada del Museo del Louvre. Un ex guardia de seguridad llamado Vicenzo Peruggia, se llevó el cuadro un lunes de 1911 para devolverlo en 1914.',
    },
  },
  '098323ks': {
    name: 'David, Michelangelo Buonarrotti',
    id: '098323ks',
    sku: 'BXD100BLK',
    price: 1504,
    ...
    attributes: {
      ...
      shape: 'Escultura (5,17 m)',
      hardiness: 'Galeria de la Academia, Florencia (Italia)',
      taste: 'Cuenta la leyenda que, al acabarlo, el artista golpeó la rodilla derecha de la estatua y le dijo “¿por qué no me hablas?”, sintiendo que la única cosa que faltaba por extraer del mármol era la propia vida',
    },
  },
  b8uthe2y: {
    name: 'La Ultima Cena, Leonardo Da Vinci',
    id: 'b8uthe2y',
    sku: 'RMRCZN7E',
    price: 1498,
    image: '/images/laultimacena.jpg',
    attributes: {
      description:
  ...
  ewxsd6xb: {
    ...
    attributes: {
      ...
      shape: 'Óleo Temple (69 x 173 cm)',
      hardiness: 'National Gallery, Londres (Reino Unido)',
      taste: 'Las avispas revoloteando al rededor de Marte son una referencia a los clientes que encargaron la pintura (Vespucci> vespa > avispa).',
    },
  },
  fpr72m9k: {
    name: 'Amor Sacro y Amor Profano, Tiziano',
    id: 'fpr72m9k',
    sku: 'B4HZ42TM',
    price: 1516,
    image: '/images/amorsacroyamorprofano.jpg',
    attributes: {
      description:
      ...
      shape: 'Óleo (118 x 279 cm)',
      hardiness: 'Galeria Borghese, Roma (Italia)',
      taste: 'Tiziano, respetado tanto hoy como cuando creaba, fue un tipo de éxito, millonario. Tenía el mundo a sus pies y recibía apulentos honorarios tanto de los políticos de la izquierda como de los curas de la derecha. Muchas voces lo acusaron de demasiado codicioso en cuanto al dinero y de no pintar en su vida ni un solo cuadro si no era por razones económicas.',
    },
  },
  t9dv25gs: {
    name: 'La Primavera, Sandro Botticelli',
    id: 't9dv25gs',
    sku: 'ZY3T9XXC',
    price: 1480,
    image: '/images/laprimavera.jpg',
    attributes: {
      description:
      ...
      shape: 'Temple (207 x 319 cm.)',
      hardiness: 'Galleria Uffizi, Florencia (Italia)',
      taste: 'El pintor, que nunca se casó, se hizo enterrar a los pies de su musa, Simonetta Vespucci, cuando ya habían pasado treinta y cuatro años de su muerte, en la Iglesia de Ognissanti de Florencia.',
    },
  },
  t345w48y: {
    name: '',
